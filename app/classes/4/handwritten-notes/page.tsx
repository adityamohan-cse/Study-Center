...
export default function Class4HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 4.",
  ...
  return (
    <ResourcePage
      title="Class 4 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 4."
      resources={resources}
    />
  )
}
