...
export default function Class3HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 3.",
  ...
  return (
    <ResourcePage
      title="Class 3 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 3."
      resources={resources}
    />
  )
}
