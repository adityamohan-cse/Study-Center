...
export default function Class5HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 5.",
  ...
  return (
    <ResourcePage
      title="Class 5 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 5."
      resources={resources}
    />
  )
}
