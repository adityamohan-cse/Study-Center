...
export default function Class1HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 1.",
  ...
  return (
    <ResourcePage
      title="Class 1 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 1."
      resources={resources}
    />
  )
}
