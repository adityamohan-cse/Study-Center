...
export default function Class9HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 9.",
  ...
  return (
    <ResourcePage
      title="Class 9 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 9."
      resources={resources}
    />
  )
}
