...
export default function Class2HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 2.",
  ...
  return (
    <ResourcePage
      title="Class 2 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 2."
      resources={resources}
    />
  )
}
