...
export default function Class7HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 7.",
  ...
  return (
    <ResourcePage
      title="Class 7 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 7."
      resources={resources}
    />
  )
}
