...
export default function Class8HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 8.",
  ...
  return (
    <ResourcePage
      title="Class 8 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 8."
      resources={resources}
    />
  )
}
