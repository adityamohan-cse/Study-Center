...
export default function Class12HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 12.",
  ...
  return (
    <ResourcePage
      title="Class 12 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 12."
      resources={resources}
    />
  )
}
