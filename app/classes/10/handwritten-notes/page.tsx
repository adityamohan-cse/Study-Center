...
export default function Class10HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 10.",
  ...
  return (
    <ResourcePage
      title="Class 10 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 10."
      resources={resources}
    />
  )
}
