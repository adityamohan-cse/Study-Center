...
export default function Class11HandwrittenNotesPage() {
  const resources = [
    {
      id: 1,
      title: "Math Concepts - Handwritten",
      description: "Neatly written notes on basic math concepts for Class 11.",
  ...
  return (
    <ResourcePage
      title="Class 11 Handwritten Notes"
      description="Browse handwritten notes for various subjects in Class 11."
      resources={resources}
    />
  )
}
